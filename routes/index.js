...
router.get('/', function (req, res) {
  res.render('index', { title: 'hillstations App', user: req.user });
});
router.get('/register', function (req, res) {
  res.render('register', { title: 'hillstations App Registration' });
});
...
router.get('/login', function (req, res) {
  res.render('login', { title: 'hillstations App Login', user: req.user });
});
